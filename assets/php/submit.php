...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="sonukumar13ap@gmail.com";  // Your Mail
	$mail->Password="ukqiatqwcmqafhha"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("sonukumar13ap@gmail.com", "Sonu Kumar"); // (Your Mail) An email address that will receive the email with the output of the form
